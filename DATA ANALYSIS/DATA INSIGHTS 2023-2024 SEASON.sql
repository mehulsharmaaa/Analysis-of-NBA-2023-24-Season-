...
SELECT *, ROW_NUMBER() OVER() AS 'STANDINGS' FROM player_stats WHERE Played > 5 ORDER BY AGE LIMIT 3;

-- 1.2) TOP 3 OLDEST PLAYERS:
SELECT *, ROW_NUMBER() OVER() AS 'STANDINGS' FROM player_stats WHERE Played > 5 ORDER BY AGE DESC LIMIT 3;
